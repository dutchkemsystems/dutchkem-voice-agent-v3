...
def test_liveness_response_schema():
    ...
    resp = LivenessResponse(is_live=True, confidence=0.95, blink_detected=True, head_movement=True)
...
class TestFaceService:
    def test_detect_and_embed_returns_faces(self):
        ...
        with patch.object(face_service, "HAS_INSIGHTFACE", True), \
    ...
    def test_verify_same_person(self):
        ...
        with patch.object(service, 'detect_and_embed') as mock_detect:
            mock_detect.return_value = [
                {"bbox": [0, 0, 100, 100], "embedding": embedding, "age": 25, "gender": "M"}
            ]
    ...
    def test_verify_different_persons(self):
        ...
        with patch.object(service, 'detect_and_embed') as mock_detect:
            ...
            mock_detect.side_effect = [
                [{"bbox": [0, 0, 100, 100], "embedding": emb1, "age": 25, "gender": "M"}],
                [{"bbox": [0, 0, 100, 100], "embedding": emb2, "age": 30, "gender": "F"}],
            ]
